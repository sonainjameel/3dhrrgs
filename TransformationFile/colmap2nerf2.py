	...
	with open(os.path.join(TEXT_FOLDER,"images.txt"), "r") as f:
		...
		for line in f:
			...
			if  i % 2 == 1:
				...
				frame = {
					"file_path": "test/{:03d}".format(i // 2),  # Converts filenames to "test/000", "test/001"
					"rotation": 0.031415926535897934,  # Fixed rotation value
					"transform_matrix": c2w.tolist()  # Convert numpy matrix to JSON-compatible list
					}
